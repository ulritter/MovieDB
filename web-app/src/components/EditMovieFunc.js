...
function EditMovieFunc(props) {
    ...
    const handleSubmit = (evt) => {
        ...
        let t = parseInt(movie.runtime);

        if (isNaN(t)) {
            errors.push("runtime");
        }

        let r = parseInt(movie.rating);
        ...
        return (
            <Fragment>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Input
                        title={"Title"}
                        className={hasErrors("title") ? "is-invalid" : ""}
                        type={'text'}
                        name={'title'}
                        value={movie.title}
                    ...
                    <Input
                        className={hasErrors("runtime") ? "is-invalid" : ""}
                        title={"Runtime"}
                        type={'text'}
                        name={'runtime'}
                        value={movie.runtime}
                    ...
                    <Input
                        className={hasErrors("rating") ? "is-invalid" : ""}
                        title={"Rating"}
                        type={'text'}
                        name={'rating'}
                        value={movie.rating}
